...
var _dropdowns = require("./modules/dropdowns");
var _initTabs = require("./modules/init-tabs");
var _initPartnersSlider = require("./modules/init-partners-slider");
var _initFeedbackSlider = require("./modules/init-feedback-slider");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _initPartnersSlider.initPartnersSlider)();
  (0, _initFeedbackSlider.initFeedbackSlider)();
...
},{"./modules/dropdowns":2,"./modules/form-validate/form":4,"./modules/init-feedback-slider":10,"./modules/init-partners-slider":11,"./modules/init-tabs":12,"./modules/input-file/init-upload":17,"./modules/modals/init-modals":20,"./modules/select/custom-select":23,"./utils/ios-vh-fix":26}],2:[function(require,module,exports){
"use strict";
...
var dropdowns = function dropdowns() {
  var menuBtns = document.querySelectorAll('.js-dropdowns');
  menuBtns.forEach(function (menuBtn) {
    menuBtn.addEventListener('click', function (evt) {
      var currentBtn = evt.currentTarget;
      menuBtns.forEach(function (menuBtnEl) {
...
exports.initFeedbackSlider = void 0;
/* global Swiper*/

var initFeedbackSlider = function initFeedbackSlider() {
  var feedbackSlider = document.querySelector('.feedback .feedback__slider');
  // eslint-disable-next-line no-unused-vars
  var feedbackSwiper = new Swiper(feedbackSlider, {
    slidesPerGroup: 3,
    slidesPerView: 3,
    speed: 1000,
    spaceBetween: 1,
...
exports.initPartnersSlider = void 0;
/* global Swiper*/

var initPartnersSlider = function initPartnersSlider() {
  var partnersSlider = document.querySelector('.partners .partners__slider');
  // eslint-disable-next-line no-unused-vars
...
exports.initPartnersSlider = initPartnersSlider;
...
var initTabs = function initTabs() {
  ...
  var servicesAndSolutions = document.querySelector('.services-and-solutions');
  var init = function init(section, header, content) {
    header.forEach(function (item) {
      item.addEventListener('click', function (evt) {
        ...
        var contentBox = section.querySelector('#' + evt.currentTarget.dataset.tab);
        contentBox.classList.remove('hidden');
      });
    });
  };
  if (catalog) {
    var tabHeadersCatalog = catalog.querySelectorAll('[data-tab]');
    var contentBoxesCatalog = catalog.querySelectorAll('[data-tab-content]');
    init(catalog, tabHeadersCatalog, contentBoxesCatalog);
  }
  if (servicesAndSolutions) {
    var tabHeadersServicesAndSolutions = servicesAndSolutions.querySelectorAll('[data-tab]');
    var contentBoxesServicesAndSolutions = servicesAndSolutions.querySelectorAll('[data-tab-content]');
...
},{"../../utils/focus-lock":24,"../../utils/scroll-lock":28}],22:[function(require,module,exports){
"use strict";
...
},{"../../utils/render":27,"./create-select-markup":22}],24:[function(require,module,exports){
"use strict";
